    ...
    lines: [
      {
        segments: {
          ...
          overhead: { enabled: true, showTiers: true, showExtended: true, showDynamicLoad: true },
          costWatch: { enabled: true, showAlerts: true },
          harness: { enabled: true, showPromptHash: false },
        },
      },
    ],
  },
